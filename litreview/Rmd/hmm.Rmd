...
## Inference
There are several quantities of interest to be inferred from different algorithms. So far, the discussion assumes that model parameters $\mat{\theta}$ are known.
