...
#' @param obs.sim A function that draws a simulated sample from the observation model. It takes only one argument, a vector of discrete states between 1 and K, and returns a vector of same size containing the sampled observations.
#'
